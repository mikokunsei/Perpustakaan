            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="action/registration.php" method="POST" novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <input type="password" name="confirm_password" class="form-control" id="yourConfirm_Password" placeholder="Confirm Password" required>
                    ...
                    <div class="col-12">
                      <input type="number" name="phone" class="form-control" id="yourPhone" placeholder="No.Telp" required>
                      <div class="invalid-feedback">Please enter your number phone!</div>
                    </div>
